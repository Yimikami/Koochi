  ...
  return (
    <>
      <button
        ...
        className="group flex w-full items-center gap-x-2 rounded-md bg-slate-200 px-2 py-2
          transition hover:bg-zinc-700/10 dark:bg-zinc-700 dark:hover:bg-zinc-700/50"
      >
